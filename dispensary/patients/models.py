...
class Patient(models.Model):
    ...
    training_from_year = models.CharField('С какого года тренируется', max_length=20, null=True, blank=True)
    ...
    umo_limit = models.CharField('Допуск УМО', max_length=255, null=True, blank=True)
    ...
    emo_limit = models.CharField('Допуск ЭМО', max_length=255, null=True, blank=True)
